                ...
                <div class="panel-body">
                    <div class="row">
                        <form action="" method="post">
                            ...
                            <div class="form-group row">
                                <label class="col-sm-2 col-form-label text-right">Buka Kelas</label>
                                <div class="col-sm-7">
                                    <input type="text" name="bukakelas" class="form-control" placeholder="Buka Kelas" value="TIDAK" readonly>
                                </div>
                            </div>
                            <div class="form-group row">
