...
if (isset($_SESSION['qrlog'])) {
    ...
    $explink = explode("/", $_SERVER['PHP_SELF']);
    if (isset($explink[3]) AND $explink[3]=="validasi") {
        $linkget = "?validasi=".$_GET['id'];
    } else {
        $linkget = "";
    }
    $linkback = $linkglobal . 'login.php'.$linkget;
            ...
            <div class="container-fluid">
                ...
                <div id="navbar-menu">
                    <ul class="nav navbar-nav navbar-right">
                        <li class="dropdown">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown"><img src="<?php echo $linkglobal; ?>assets/img/user-medium.png" class="img-circle" alt="Avatar"> <span><?php echo $namauser; ?></span> <i class="icon-submenu lnr lnr-chevron-down"></i></a>
